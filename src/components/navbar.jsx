...
const Navbar = () => {
  ...
  return (
    <div className=' font-["Big Shoulders Inline"]  NAVBAR fixed z-[999] w-full px-4 sm:px-10 md:px-20 py-4 md:py-8 flex justify-between items-center bg-white'>
         <div className='logo'> 
         <svg color='black' width="72" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
